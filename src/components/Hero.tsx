        ...
        <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-16">
          <div className="flex-1 space-y-6">
            ...
            <h1 className="heading-xl !leading-tight">
              Unlock Text from <span className="text-copyblue">Any File</span>,
              Instantly
            </h1>

            <p className="text-lead max-w-2xl">
              Extract text from PDFs, Word documents, Excel spreadsheets, and
              more with a simple drag and drop. No sign-up, no uploads, and no
